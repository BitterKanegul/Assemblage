...
def build_hook(build_dir,
    ...
    res = cmd_with_output(f"{vcvarsall_loc} {arch} &&" +
                          ...
                          f"cmake .. -A {arch} -DBUILD_TESTING=ON " +
                          f"-DCMAKE_BUILD_TYPE={build_mode} " +
                          f"-DCMAKE_INSTALL_PREFIX=C:\\\\LibUV\\Binaries &&" +
...
obj = CustomWindowsBuild(clone_dir='C:\\\\LibUV\\libuv',
                         clone_flags='',
                         collect_dir="C:\\Binaries",
                         source_dir='C:\\\\LibUV\\libuv',
                         build_dir=f'C:\\\\LibUV\\Binaries',
                         project_git_url='https://github.com/libuv/libuv.git',
                         optimization='',
                         build_mode='Debug',
                         arch=arch,
                         tags=['v1.47.0', 'v1.46.0', 'v1.45.0', 'v1.44.0'],
